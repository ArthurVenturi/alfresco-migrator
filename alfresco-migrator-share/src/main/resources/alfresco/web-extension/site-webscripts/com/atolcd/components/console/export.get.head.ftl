...
<!-- Admin Console Export Tool -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/alfresco-migrator-share/components/console/export/export.css" />
...
<@script type="text/javascript" src="${page.url.context}/res/alfresco-migrator-share/components/console/export/export.js"></@script>
