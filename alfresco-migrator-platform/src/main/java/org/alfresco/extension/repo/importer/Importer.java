...
public interface Importer
{
    ...
    /**
     * Apply version-history data parsed for a node after node import/update has been
     * resolved.
     *
     * @param node    parsed node context
     * @param nodeRef imported node reference
     */
    public void applyVersionHistory(ImportNode node, NodeRef nodeRef);
