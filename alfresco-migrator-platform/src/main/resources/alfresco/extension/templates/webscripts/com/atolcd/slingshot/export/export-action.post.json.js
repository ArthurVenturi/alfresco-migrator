...
function main() {
  try {
    ...
    if (json.has("include-versions")) {
      includeVersions = (Boolean(json.get("include-versions")));
    }

    // create export action
    var exporter = actions.create("migratorExporter");
    ...
    exporter.parameters['include-versions'] = includeVersions;
